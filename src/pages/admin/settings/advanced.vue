...
import { ref } from 'vue'
import PlatformSettings from '@/components/admin/settings/advanced/PlatformSettings.vue'
import IntegrationsSettings from '@/components/admin/settings/advanced/IntegrationsSettings.vue'
import DomainsSettings from '@/components/admin/settings/advanced/DomainsSettings.vue'
import DataManagement from '@/components/admin/settings/advanced/DataManagement.vue'
