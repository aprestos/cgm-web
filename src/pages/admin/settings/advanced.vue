...
import { ref } from 'vue'
import PlatformSettings from '@/views/admin/settings/advanced/PlatformSettings.vue'
import IntegrationsSettings from '@/views/admin/settings/advanced/IntegrationsSettings.vue'
import DomainsSettings from '@/views/admin/settings/advanced/DomainsSettings.vue'
import DataManagement from '@/views/admin/settings/advanced/DataManagement.vue'
