...
<template>
  <section id="games" class="relative overflow-hidden py-32">
    ...
    <div class="relative z-10 mx-auto max-w-7xl px-4">
      ...
      <!-- Games Scroll -->
      <div class="mt-12 -mx-4 overflow-x-auto px-4 pb-4 scrollbar-hide">
        <div class="flex gap-6" style="width: max-content">
          ...
          >
            ...
            <!-- Overlay -->
            <div
              class="absolute inset-0 bg-gradient-to-t from-gray-900 via-gray-900/50 to-transparent dark:from-gray-950 dark:via-gray-950/50"
            />
