    ...
    <div class="relative z-10 mx-auto max-w-7xl px-4">
      ...
      <div class="flex items-end justify-between">
        ...
        <RouterLink
          ...
          class="hidden items-center gap-2 text-sm font-medium text-gray-600 dark:text-white/60 transition-colors hover:text-violet-600 dark:hover:text-white sm:flex"
        >
      ...
      >
        <RouterLink
          ...
          :key="game.id"
          :class="[
            'group relative overflow-hidden rounded-2xl bg-white dark:bg-gray-900 ring-1 ring-gray-200 dark:ring-white/10 shadow-lg dark:shadow-none transition-all duration-300 hover:ring-violet-300 dark:hover:ring-white/20 hover:shadow-xl',
