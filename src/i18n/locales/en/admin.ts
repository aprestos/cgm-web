...
export default {
  ...
  tournaments: {
    ...
    participantsDialog: {
      title: 'Participants',
      count: '{count} of {max} participants',
      participant: 'Participant',
      email: 'Email',
      joined: 'Joined',
      signedUpBy: 'Signed up by',
      byUser: 'by {name}',
      fromTicket: 'Sign-up backed by a ticket',
      searchLabel: 'Search participants',
      searchPlaceholder: 'Search by name or email',
      unnamed: 'Unnamed participant',
      empty: 'No one has signed up yet',
      noMatches: 'No participant matches "{query}"',
      loadFailed: 'Failed to load the participants',
      add: {
        ...
        failed: 'Failed to add the participant',
        duplicate: '{name} is already in this tournament',
        full: 'This tournament is full — remove someone to free a spot',
      },
      remove: {
        action: 'Remove {name}',
    ...
    edit: {
      ...
      keepCover: 'Keep it',
      coverWillBeRemoved: 'The cover will be removed when you save.',
      minParticipants: 'At least {count} — already signed up',
      noPrizes: 'No prizes set',
      noDescription: 'No description yet',
      manageParticipants: 'Manage participants',
      saveFailed: 'Unable to save the changes. Try again later.',
      saveSuccess: 'Successfully updated tournament.',
    },
    preview: {
      title: 'Preview',
      hint: 'How players will see this tournament.',
      untitled: 'Untitled tournament',
    },
    form: {
      sections: {
        cover: 'Cover',
        identity: 'Name & organizer',
        facts: 'Details',
        prizes: 'Prizes',
        about: 'About',
      },
