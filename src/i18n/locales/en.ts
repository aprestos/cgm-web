...
const en = {
  ...
  checkout: {
    ...
    payment: {
      ...
      confirmationTimeout:
        'We could not confirm your payment in time. Sometimes the validation may take longer than expected, you can refresh the page to check again. If you have any doubts contact us at {email}',
    },
    confirming: {
