...
import type { TicketAttendee } from '@/components/checkout/checkout.model.ts'
  ...
  <div class="space-y-5">
    ...
    >
      <p class="text-sm text-gray-600 dark:text-gray-300">
        {{ t('landing.checkout.completed.reference') }}:
    ...
    <div>
      <h3 class="text-sm font-semibold text-gray-700 dark:text-gray-200">
        {{ t('landing.checkout.completed.attendees') }}
      </h3>
