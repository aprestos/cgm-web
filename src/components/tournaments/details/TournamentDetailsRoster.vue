...
import TournamentParticipantRow from '@/components/tournaments/details/TournamentParticipantRow.vue'
import TournamentRosterMeter from '@/components/tournaments/details/TournamentRosterMeter.vue'
